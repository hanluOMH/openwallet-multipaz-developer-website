...
Copy and rename the JAR file to the deployment directory:

```bash
# Copy and rename the JAR file to the multipaz-records-server directory
cp multipaz-records-server/build/libs/multipaz-records-server-all.jar multipaz-records-server/app.jar
```
...
```bash
# Copy and rename the JAR file to the multipaz-openid4vci-server directory
cp multipaz-openid4vci-server/build/libs/multipaz-openid4vci-server-all.jar multipaz-openid4vci-server/app.jar
```
